...
import { mudarStatus, type NegocioState } from "@/actions/negocios";
...
/**
 * Select que muda o status de um negócio na hora (submete ao escolher).
...
export function StatusSelect({
  ...
  const [, formAction, pending] = useActionState<NegocioState, FormData>(
    mudarStatus,
    {},
  );
